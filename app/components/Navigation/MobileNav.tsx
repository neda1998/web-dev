...
const MobileNav = ({nav,closeNav}:Props) => {
    ...
    return (
        <div className={`transform ${navOpenStyle} transition-all duration-500 fixed top-0 left-0 z-[200] h-[100vh] right-0 bottom-0 bg-[#6d096b]`}>
            ...
            <ul className="relative z-[201] space-y-10 flex flex-col justify-center h-[100%] items-center">
                ...
                <li className="text-[25px] cursor-pointer hover:text-yellow-300 text-white transition-all duration-200">
