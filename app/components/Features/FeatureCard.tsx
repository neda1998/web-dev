...
const FeatureCard = ({image,title}:Props) => {
  return (
    <div className='text-center bg-gray-100 p-4 rounded-lg hover:shadow-lg transition-all duration-300 cursor-pointer hover:scale-105'>
        ...
        <p className='mt-[1rem] text-black opacity-90 text-[15px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. In labore soluta impedit aspernatur quam assumenda laboriosam facere libero voluptatem neque!</p>
